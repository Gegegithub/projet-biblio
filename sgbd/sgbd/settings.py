...
import os
import pymysql
pymysql.install_as_MySQLdb() #remplace le pilote mysqldb 
...
SECRET_KEY = 'django-insecure-ihv-ux+3z&oby#8emah0jc5m6d^w=689#!h2mbs^^4fwao+iq+'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',  # Utilise MySQL comme moteur de base de données
        'NAME': 'sgbd',
        'USER' : 'root',
        'PASSWORD':'',
        'HOST': '127.0.0.1',
...
# STATIC_URL ='static/'
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Si tes fichiers statiques sont dans un dossier nommé 'static'
